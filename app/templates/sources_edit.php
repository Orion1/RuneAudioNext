	...
	<form class="form-horizontal" action="/sources/" method="post" role="form" data-validate="parsley">
		<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<option value="osx" <?php if($this->mount['type'] == 'osx'): ?> selected <?php endif ?>>SMB/CIFS (shared by Mac OS X)</option>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control input-lg" type="text" id="nas-ip" name="mount[address]" value="<?=$this->mount['address']?>" data-trigger="change" placeholder="es: 192.168.1.250">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control input-lg" type="text" id="nas-dir" name="mount[remotedir]" value="<?=$this->mount['remotedir']?>" data-trigger="change" placeholder="es: Music/Classical">
			...
			<div id="mount-cifs" class="optional">
				...
				<div id="mount-auth" class="optional disabled">
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input class="form-control input-lg" type="text" id="nas-usr" name="mount[username]" value="<?=$this->mount['username']?>" data-trigger="change" placeholder="user">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input class="form-control input-lg" type="password" id="nas-pasw" name="mount[password]" value="<?=$this->mount['password']?>" placeholder="pass" autocomplete="off">
		...
		<fieldset id="mount-advanced-config" class="hide">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control input-lg" type="text" id="nas-rsize" name="mount[rsize]" value="<?=$this->mount['rsize']?>" data-trigger="change" placeholder="8192">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control input-lg" type="text" id="nas-wsize" name="mount[wsize]" value="<?=$this->mount['wsize']?>" data-trigger="change" placeholder="16384">
					<span class="help-block">Change this settings if you experience problems with music playback (es: pops or clips)</span>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control input-lg" type="text" id="options" name="mount[options]" value="<?=$this->mount['options']?>" data-trigger="change" placeholder="cache=strict,ro">
