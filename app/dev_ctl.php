...
<div class="container">
	<h1>Development settings</h1>
		...
		<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="btn btn-default" type="submit" name="syscmd" value="phpclearcache" id="syscmd-phpclearcache">
				</div>
			</div>			
			<div class="form-group">
				<label class="col-sm-2 control-label">View PHP 5.5 OPcache status</label>
				<div class="col-sm-10">
					<a class="btn btn-default" type="submit" href="command/opcache.php" name="syscmd" id="syscmd-viewphpcache" target="_blank">php cache status</a>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">Restart PHP service</label>
				<div class="col-sm-10">
					<input class="btn btn-default" type="submit" name="syscmd" value="phprestart" id="syscmd-phprestart">
				</div>
			</div> 
		<div class="form-group">
			...
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					<button class="btn btn-primary btn-lg" value="apply" name="apply" type="submit">Save settings</button>
				</div>
			</div>
		</fieldset>
	</form>
	<form class="form-horizontal" method="post">
		<fieldset>
			...
			<div class="form-group">
				<label class="col-sm-2 control-label">Debug level</label>
				<div class="col-sm-10">
					<select name="debug" class="selectpicker" data-style="btn-default btn-lg">
			...
			<!--<div class="form-group">
				<label class="col-sm-2 control-label">VM RuneAudio DEV</label>
				<div class="col-sm-10">
					<div class="toggle">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label">Hide debug informations</label>
				<div class="col-sm-10">
					<div class="toggle">
			...
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					<button class="btn btn-primary btn-lg" value="save" name="save" type="submit">Save settings</button>
				</div>
			</div>
		</fieldset>
	</form>
	<form class="form-horizontal" method="post">
		<fieldset>
			...
			<div class="form-group">
				<label class="col-sm-2 control-label">System reboot</label>
				<div class="col-sm-10">
					<input class="btn btn-default" type="submit" name="syscmd" value="reboot" id="syscmd-reboot">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">System poweroff</label>
				<div class="col-sm-10">
					<input class="btn btn-default" type="submit" name="syscmd" value="poweroff" id="syscmd-poweroff">
				</div>
			</div>
			<!--<div class="form-group">
				<label class="col-sm-2 control-label">Setup FS permissions</label>
				<div class="col-sm-10">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="btn btn-default" type="submit" name="syscmd" value="netconfreset" id="syscmd-netconfreset">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">reset MPD config</label>
				<div class="col-sm-10">
					<input class="btn btn-default" type="submit" name="syscmd" value="mpdconfreset" id="syscmd-mpdconfreset">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">blank playerID</label>
				<div class="col-sm-10">
					<input class="btn btn-default" type="submit" name="syscmd" value="blankplayerid" id="syscmd-blankplayerid">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="btn btn-default" type="submit" name="syscmd" value="clearimg" id="syscmd-clearimg">
	...
	<form class="form-horizontal" method="post">
		<fieldset>
			...
			<div class="form-group">
				<label class="col-sm-2 control-label">restart WORKER</label>
				<div class="col-sm-10">
					<input class="btn btn-default" type="submit" name="syscmd" value="workerrestart" id="syscmd-workerrestart">
				</div>
			</div>	
			<div class="form-group">
				<label class="col-sm-2 control-label">reset WORKER session</label>
				<div class="col-sm-10">
					<input class="btn btn-default" type="submit" name="syscmd" value="workersessionreset" id="syscmd-workersessionreset">
				</div>
			</div>	
		</fieldset>
	</form>
<!-- <form class="form-horizontal" method="post">
		<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="btn btn-default" type="submit" name="syscmd" value="backup" id="syscmd-backup">
				</div>
			</div>
					</fieldset>
	</form>
