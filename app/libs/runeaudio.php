...
function redisDatastore($redis,$action) {
	...
	switch ($action) {
			...
			$redis->hSet('acards_details','snd_rpi_iqaudio_dac','{"extlabel":"I&#178;S &#8722; (IQaudIO Pi-DAC)","mixer_numid":"1","mixer_control":"Playback Digital","hwplatformid":"01","type":"i2s"}');
			...
			$redis->hSet('acards_details','raspi2splay3','{"extlabel":"I&#178;S &#8722; (RaspI2SPlay3)","hwplatformid":"01","type":"i2s"}');
